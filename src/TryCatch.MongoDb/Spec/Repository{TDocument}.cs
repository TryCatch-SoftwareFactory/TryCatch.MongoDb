// <copyright file="Repository{TDocument}.cs" company="TryCatch Software Factory">
...
namespace TryCatch.MongoDb.Spec
{
    ...
    public abstract class Repository<TDocument> : Linq.Repository<TDocument>, Patterns.Repositories.Spec.IRepository<TDocument>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public async virtual Task<bool> DeleteAsync(ISpecification<TDocument> spec, CancellationToken cancellationToken = default)
        {
