...
namespace TryCatch.MongoDb.UnitTests.Spec
{
    ...
    {
        private const string TestName = "SPEC-EXT_REPOSITORY-TEST";

        private readonly IExtendedRepository<Vehicle> sut;
        ...
        {
            // Arrange
            var spec = Given.VehicleToDeleteSpecExtendedRepositoryTest;
